...
<template>
    <div>
        <!-- {{ console() }} -->
        <v-dialog v-model="this.$store.state.isDetailModalOpen" @input="$emit('update:value', $event)" max-width="1000px">
            <v-card>
                ...
                <v-form>
                    <v-container>
                        ...
                        <v-row>
                            ...
                            <v-col cols="12" md="6">
                                <h4 class="mb-3">Durum</h4>
                                <v-text-field required variant="outlined">{{
                                    requestData.status }}</v-text-field>
                            </v-col>
                        </v-row>
                    </v-container>
                </v-form>
